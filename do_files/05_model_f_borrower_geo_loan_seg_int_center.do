...
stcrreg  i.race##c.income i.fico_ i.race##c.m_dwb_a_09 m_dwh_a_09 m_dwa_a_09 i.region i.highcost ltv i.purpose i.arm i.mod i.pti_dummy c.putoption##c.putoption c.calloption##c.calloption i.year, compete(outcome == 1) vce(cluster id)
est sto dissimilarity
est save "$results/borrower_geo_loan_seg_int_center", replace
