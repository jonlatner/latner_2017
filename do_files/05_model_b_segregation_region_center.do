...
*stcrreg  i.race##c.income i.fico_ per_poor per_nonwhite m_dwb_a_09 m_dwh_a_09 m_dwa_a_09 highcost ltv i.purpose i.arm i.mod i.pti_dummy c.putoption##c.putoption c.calloption##c.calloption i.year, compete(outcome == 1) vce(cluster id)
stcrreg  m_dwb_a_09 m_dwh_a_09 m_dwa_a_09 i.year i.region, compete(outcome == 1) vce(cluster id)
est sto dissimilarity
est save "$results/segregation_region_center", replace
