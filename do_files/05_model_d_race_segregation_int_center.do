...
stcrreg  i.race##c.income i.race##c.m_dwb_a_09 m_dwh_a_09 m_dwa_a_09 i.year i.region, compete(outcome == 1) vce(cluster id)
est sto dissimilarity
est save "$results/race_segregation_int_center", replace
